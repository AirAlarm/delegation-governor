...
# dependencies = ["mcp<2"]  # station patch: mcp 2.x renamed FastMCP -> MCPServer, breaks this 0.12.0 code
# ///
...
async def run_dev_task(
    ...
    args = {
        ...
        "api_base": resolved["api_base"],  # station patch: thread to worker
